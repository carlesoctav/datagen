...
def write_all_wildchat_examples():
    output_file = "wild_chat.md"
    ...
    print(f"Writing WildChat examples to {output_file}...")

    with open(output_file, "w") as f:
        f.write("# WildChat Comparison: Gemma-3-1b-it (Model 1) vs mm-01 (Model 2)\n\n")
        ...
        for i, comp in enumerate(comparisons):
            ...
            # Filter for WildChat source only
            if source == "wildchat":
                count += 1
