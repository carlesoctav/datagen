...
def write_all_reasoning_examples():
    output_file = "reasoning.md"
    ...
    print(f"Writing Reasoning examples to {output_file}...")

    with open(output_file, "w") as f:
        f.write(
            "# Reasoning Comparison: Gemma-3-1b-it (Model 1) vs mm-01 (Model 2)\n\n"
        )
        ...
        for i, comp in enumerate(comparisons):
            ...
            # Filter for Reasoning source only
            if source == "reasoning":
                count += 1
